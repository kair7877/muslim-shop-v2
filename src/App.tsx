...
export default function App() {
  ...
  // Real-time Cloud Sync with Firebase Firestore (all devices see updates instantly)
  useEffect(() => {
  ...
  const [mobileTab, setMobileTab] = useState<'home' | 'search' | 'catalog' | 'cart' | 'admin'>('home');
  ...
  const handleMobileNavTab = (tab: 'home' | 'search' | 'catalog' | 'cart' | 'admin') => {
    setMobileTab(tab);
    if (tab === 'home') {
  ...
  return (
    <div className="min-h-screen bg-[#0B0B0E] text-[#F4F1EA] flex flex-col selection:bg-[#D4AF37]/30 selection:text-[#E8D49E]">
      {/* 1. Header with Language RU/KZ, Search, Cart */}
      <Header
        language={language}
      ...
      <main className="flex-grow">
        ...
        {/* 3. Horizontal Categories ribbon immediately after Hero */}
        <CategoryNav
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <h2 className="font-serif text-xl sm:text-2xl font-bold text-[#F4F1EA]">
                  {selectedCategoryId
                    ? categories.find((c) => c.id === selectedCategoryId)?.nameRu || t.allProducts
                    : t.allProducts}
                </h2>
          ...
          {filteredProducts.length === 0 ? (
            <div className="py-16 text-center bg-[#13131A] rounded-3xl border border-[#242432] p-8">
              ...
              <button
                ...
                className="px-5 py-2.5 rounded-xl bg-[#C5A059] text-[#0B0B0E] font-bold text-xs"
              >
                {t.resetFilters}
              </button>
            </div>
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
            <div className="flex flex-col items-center">
              ...
              <h4 className="text-xs sm:text-sm font-semibold text-[#F4F1EA]">
                Оригинальная Halal продукция
              </h4>
              <p className="text-[11px] text-[#8C877D] mt-0.5 max-w-xs">
                Сертифицированные натуральные масла, витамины и благородные ароматы
              </p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-[11px] text-[#8C877D] mt-0.5 max-w-xs">
                Возможность прийти, посмотреть и забрать заказ самовывозом
              </p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-[11px] text-[#8C877D] mt-0.5 max-w-xs">
                Прямая связь с консультантом бутика в один клик
              </p>
            </div>
          </div>
        </section>
      ...
      {/* 7. Mobile Bottom Fixed Navigation */}
      <BottomNav
      ...
      {/* 8. Full Product Modal Details Page */}
      <ProductModal
