          ...
          <div className="flex flex-col gap-2">
            ...
            {settings.instagram && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl bg-[#1C1726] hover:bg-[#282136] border border-[#553C9A]/50 text-[#D6BCFA] text-xs font-medium transition-colors"
              >
                <Instagram className="w-4 h-4" />
                <span>Instagram: @{settings.instagram.replace('@', '')}</span>
              </a>
            )}
          </div>
        </div>
