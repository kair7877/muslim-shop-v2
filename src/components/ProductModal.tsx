...
import { X, ShoppingBag, Zap, Check, ChevronLeft, ChevronRight, Maximize2, MessageCircle, Sparkles } from 'lucide-react';
            ...
            <div className="flex flex-col justify-between">
              ...
              <div className="mt-6 pt-4 border-t border-[#22222E] space-y-3">
                ...
                <button
                  ...
                  className="w-full py-2.5 px-4 rounded-xl bg-[#1E2E24] hover:bg-[#253A2C] border border-[#276749]/50 text-[#68D391] text-xs font-medium flex items-center justify-center gap-2 transition-colors cursor-pointer"
                >
