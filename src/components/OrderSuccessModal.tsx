...
import { CheckCircle2, MessageCircle, X, ArrowRight } from 'lucide-react';
      ...
      >
        ...
        <div className="space-y-2.5">
          <button
            ...
            className="w-full py-3 px-4 rounded-xl font-semibold text-xs sm:text-sm bg-[#22543D] hover:bg-[#276749] text-white flex items-center justify-center gap-2 border border-[#38A169]/50 shadow-md transition-all cursor-pointer"
          >
            <MessageCircle className="w-4 h-4" />
            <span>{t.sendViaWhatsAppDirect}</span>
          </button>
